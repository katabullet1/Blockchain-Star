...
contract Ownable {
    ...
    modifier onlyOwner()
    {
        require(_owner==msg.sender, " only the owner is allowed");
        _;
    }
    ...
    onlyOwner
    {
        // make sure that the new owner is a real address
        _owner=newOwner;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function ownerOff(uint256 tokenId) public view returns (address) {
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != currentOwner, "to is already owner of token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
         require(((currentOwner != msg.sender) || isApprovedForAll(currentOwner, msg.sender)), "Can not approve");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "Wrong or invalid address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "Not an owner. Hence, no processing of token transfer");
...
contract CustomERC721Token is ERC721Metadata("My Capstone Real Estate Project ", "SNN", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
